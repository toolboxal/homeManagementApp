...
INSERT INTO `__new_store_items`("id", "name", "date_bought", "date_expiry", "cost", "status", "quantity", "amount", "category", "location_id", "spot_id", "direction_id") SELECT "id", "name", "date_bought", "date_expiry", "cost", "status", "quantity", "amount", "category", "location_id", "spot_id", "direction_id" FROM `store_items`;--> statement-breakpoint
